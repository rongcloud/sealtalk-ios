...
// 返回当前用户的风险等级接口
- (void)getFrandPreventionRiskLevelWithPhone:(nonnull NSString *)phone withRegion:(nonnull NSString *)region success:(void (^)(RCDFraudPreventionRiskLevelCode code))successBlock error:(void (^)(NSInteger code))errorBlock{
    __weak typeof(self) weakSelf = self;

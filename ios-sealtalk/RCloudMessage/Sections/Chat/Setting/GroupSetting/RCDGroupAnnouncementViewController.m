...
- (UITextViewAndPlaceholder *)announcementContent {
    if (!_announcementContent) {
        ...
        _announcementContent.textColor = [RCDUtilities generateDynamicColor:HEXCOLOR(0x939393) darkColor:[HEXCOLOR(0xffffff) colorWithAlphaComponent:0.9]];
...
- (UILabel *)guideLabel {
    if (!_guideLabel) {
        ...
        _guideLabel.textColor = [RCDUtilities generateDynamicColor:HEXCOLOR(0x939393) darkColor:[HEXCOLOR(0xffffff) colorWithAlphaComponent:0.6]];
...
- (UILabel *)updateTime {
    if (!_updateTime) {
        ...
        _updateTime.textColor = [RCDUtilities generateDynamicColor:HEXCOLOR(0x939393) darkColor:[HEXCOLOR(0xffffff) colorWithAlphaComponent:0.6]];

...
- (void)setupTextMessageContent {
    ...
    self.messageContentLabel.textColor = RCDynamicColor(@"text_primary_color", @"0x525A63", @"0xb9b9b9");
...
- (void)setupFileMessageContent {
    ...
    self.messageContentLabel.textColor = RCDynamicColor(@"text_primary_color", @"0x020814", @"0xffffff");
    self.messageContentLabel.textAlignment = NSTextAlignmentNatural;
    self.messageContentLabel.numberOfLines = 2;
    ...
    self.fileSizeLabel.textColor = RCDynamicColor(@"text_secondary_color", @"0x7C838e", @"0x7C838e");
...
- (UIView *)contentView {
    if (!_contentView) {
        ...
        _contentView.backgroundColor = RCDynamicColor(@"common_background_color",@"0xFFFFFF",@" 0x141414");
...
- (UILabel *)senderNameLabel {
    if (!_senderNameLabel) {
        ...
        _senderNameLabel.textColor = RCDynamicColor(@"text_primary_color",@"0x252525", @"0x9f9f9f");

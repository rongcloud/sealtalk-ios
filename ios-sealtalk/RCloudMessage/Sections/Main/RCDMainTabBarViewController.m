...
- (void)setControllers {
    ...
    RCNDMeViewController *discoveryVC = [[RCNDMeViewController alloc] initWithViewModel:meViewModel];
...
- (void)setTabBarItems:(NSArray *)viewControllers  {
    ...
    [viewControllers
        ...
        if([objNavi isKindOfClass:[UINavigationController class]]) {
            ...
            if ([obj isKindOfClass:[RCDChatListViewController class]] || [obj isKindOfClass:[RCDContactViewController class]] || [obj isKindOfClass:[RCNDMeViewController class]] || [obj isKindOfClass:[RCDMeTableViewController class]] || [obj isKindOfClass:[RCDUltraGroupController class]]) {
